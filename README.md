...
1.0 Release version supports only hitscan weapons like pistol, shotguns, chaingun.
...
I prefer to set that to 512 so it will be able to penetrate default doom doors but not anything thicker.
